...
render_all() {
    N=$(n_frames $1)
    render $1 refine/base-propagate-dot-cotracker3 $2 $3 2 $N
    render $1 refine/base-base-dot-cotracker3 $2 $3 2 $N
    render $1 train/regularized $2 $3 2 $N
    render $1 train/hicom $2 $3 2 $N
