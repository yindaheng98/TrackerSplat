...
INITTRAININGARGSCOMMON=$INITTRAININGARGSCOMMON" -oscale_reg_from_iter=500"
INITTRAININGARGSCOMMON=$INITTRAININGARGSCOMMON" -oscale_reg_thr_scale=0.5"
INITTRAININGARGSCOMMON=$INITTRAININGARGSCOMMON" -odepth_from_iter=500"
...
INITTRAININGARGSCOMMON=$INITTRAININGARGSCOMMON" -odepth_local_relative_kernel_radius=32"
INITTRAININGARGSCOMMON=$INITTRAININGARGSCOMMON" -odepth_local_relative_stride=16"
INITTRAININGARGSCOMMON=$INITTRAININGARGSCOMMON" -odepth_resize=577"

INITTRAININGARGSDENSIFY=""
INITTRAININGARGSDENSIFY=$INITTRAININGARGSDENSIFY" -odensify_percent_too_big=0.3"
