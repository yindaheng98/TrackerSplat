...
class Dinov2SegFeatureExtractor(FeatureExtractor):
    def __init__(
            self,
            configfile: str = 'small',
            device: torch.device = torch.device("cuda")):
        super().__init__()
        backbone_arch = backbone_archs[configfile]
        ...
        load_pretrained_weights(self.model, f"./checkpoints/dinov2_{backbone_arch}_reg4_pretrain.pth", "teacher")
