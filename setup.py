...
setup(
    ...
    packages=packages + packages_dot,
    package_dir={
        'instantsplatstream': 'instantsplatstream',
        'dot': 'submodules/dot/dot',
        'instantsplatstream.diff_gaussian_rasterization': 'submodules/diff-gaussian-rasterization/diff_gaussian_rasterization',
    },
    ext_modules=[
        CUDAExtension(
            name="instantsplatstream.diff_gaussian_rasterization._C",
