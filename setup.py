...
setup(
    ...
    packages=packages + packages_dot + ['instantsplatstream.pixelsplatter.diff_gaussian_rasterization'],
    package_dir={
        'instantsplatstream': 'instantsplatstream',
        'dot': 'submodules/dot/dot',
        'instantsplatstream.pixelsplatter.diff_gaussian_rasterization': 'submodules/diff-gaussian-rasterization/diff_gaussian_rasterization',
    },
    ext_modules=[
        CUDAExtension(
            name="instantsplatstream.pixelsplatter.diff_gaussian_rasterization._C",
